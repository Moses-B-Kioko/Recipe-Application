                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" id="name" class="form-control"
                                 placeholder="Name" value="{{$category->name}}" autocomplete="name"> <!-- Added autocomplete -->
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="hidden" id="image_id" name="image_id" value="" autocomplete="off"> <!-- Disable autocomplete for hidden field -->
