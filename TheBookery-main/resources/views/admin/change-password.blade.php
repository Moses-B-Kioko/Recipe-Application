...
<section class="content">
	...
	<div class="container-fluid">
        @include('admin.message')
            <form action="" method="post" id="changePasswordForm" name="changePasswordForm" autocomplete="off"> <!-- Disable autofill for the entire form if needed -->
            @csrf
            @method('POST')
            <div class="card">
                <div class="card-body">								
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="password" name="old_password" id="old_password" class="form-control" placeholder="Old Password" autocomplete="name"> <!-- Added autocomplete -->
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="password" name="new_password" id="new_password" class="form-control" placeholder="New Password" autocomplete="name"> <!-- Added autocomplete -->
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="password" name="confirm_password" id="confirm_password" class="form-control" placeholder="Confirm Password" autocomplete="name"> <!-- Added autocomplete -->
                                <p></p>
                            </div>
                        </div>
