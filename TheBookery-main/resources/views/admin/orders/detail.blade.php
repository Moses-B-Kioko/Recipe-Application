    ...
    <div class="container-fluid my-2">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 d-flex justify-content-end">
                <a href="{{ route('orders.adminIndex') }}" class="btn btn-primary">Back</a>
            </div>
        </div>
    </div>
    <!-- /.container-fluid -->
...
<script>
    ...
    $("#changeOrderStatusForm").submit(function(event){
        ...
        if (confirm("Are you sure you want to change status?")) {
            $.ajax({
                url:'{{ route("orders.adminChangeOrderStatusForm",$order->id) }}',
                type: 'post',
                data: $(this).serializeArray(),
                dataType: 'json',
                success: function(response){
                    window.location.href='{{ route("orders.adminDetail",$order->id) }}';
                }
            });
        }
    });
    ...
    $("#sendInvoiceEmail").submit(function(event){
        ...
        if (confirm("Are you sure you want to send email?")) {
            $.ajax({
                url:'{{ route("orders.adminSendInvoiceEmail",$order->id) }}',
                type: 'post',
                data: $(this).serializeArray(),
                dataType: 'json',
                success: function(response){
