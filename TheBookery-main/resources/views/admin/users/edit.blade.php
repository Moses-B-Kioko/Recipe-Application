                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input value="{{ $user->name }}" type="text" name="name" id="name" class="form-control" placeholder="Name" autocomplete="name"> <!-- Added autocomplete -->
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input value="{{ $user->email }}"  type="text" name="email" id="email" class="form-control" placeholder="Email" autocomplete="slug"> <!-- Added autocomplete -->
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input value="{{ $user->phone }}"  type="text" name="phone" id="phone" class="form-control" placeholder="Phone" autocomplete="slug"> <!-- Added autocomplete -->
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
