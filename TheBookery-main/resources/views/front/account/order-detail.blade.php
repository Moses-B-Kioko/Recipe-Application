                                ...
                                <div class="card-body bg-light mb-3">
                                    <div class="row">
                                        ...
                                        <div class="col-6 col-lg-3">
                                            ...
                                            <!-- Text -->
                                            <p class="mb-0 fs-sm fw-bold">
                                            Ksh.{{ number_format($order->grand_total,2) }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <li class="list-group-item">
                                    <div class="row align-items-center">
                                        <div class="col-4 col-md-3 col-xl-2">
                                            ...
                                            @php
                                            $bookImage = getBookImage($item->book_id);
                                            
                                            @endphp
                                            @if (!empty($bookImage->image))  
                                            <img class="img-fluid" src="{{ asset('uploads/book/small/'.$bookImage->image)}}" >
                                            @else 
                                        ...
                                        <div class="col">
                                            ...
                                            <p class="mb-4 fs-sm fw-bold">
                                                ...
                                                <span class="text-muted">Ksh.{{$item->total}}</span>
                                            </p>
                                        </div>
                                    </div>
                                </li>
                        ...
                        <div class="card-body">
                            ...
                            <ul>
                                <li class="list-group-item d-flex">
                                    <span>Subtotal</span>
                                    <span class="ms-auto">Ksh.{{ number_format($order->subtotal, 2) }}</span>
                                </li>
                                <!--<li class="list-group-item d-flex">
                                    <span>Discount</span>
                                ...
                                <li class="list-group-item d-flex">
                                    <span>Shipping</span>
                                    <span class="ms-auto">Ksh.{{ number_format($order->shipping, 2) }}</span>
                                </li>
                                <li class="list-group-item d-flex fs-lg fw-bold">
                                    <span>Grand Total</span>
                                    <span class="ms-auto">Ksh.{{ number_format($order->grand_total, 2) }}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
